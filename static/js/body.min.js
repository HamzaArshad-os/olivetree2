...
var arrayofcarousels = ["carousel0","carousel1","carousel2"]
var affectedcarouselnumber;
var affectedcarousel;
var images;


var bee = function () {
  affectedcarousel = "." + affectedcarouselnumber;
  images = document.querySelectorAll(affectedcarousel);
...
var myFunctiongoBack = function (ac) {//works
  affectedcarouselnumber = arrayofcarousels[ac];
  console.log(affectedcarousel);
  bee()
        if(i != 0 ){
...
var myFunctiongoForward = function (ac) {//fixed
  affectedcarousel = ac;
